...
set design_name PWM_Manager_6CH
...
# Hierarchical cell: Channel_CH06
proc create_hier_cell_Channel_CH06 { parentCell nameHier } {

  if { $parentCell eq "" || $nameHier eq "" } {
     puts "ERROR: create_hier_cell_Channel_CH06() - Empty argument(s)!"
     return
  }
  ...
  # Create interface pins
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 S00_AXI_CH06

  # Create pins
  create_bd_pin -dir I -type clk CLK
  create_bd_pin -dir I PWM_CH06
  create_bd_pin -dir I -from 1 -to 0 mode
  create_bd_pin -dir O pwm_CH06_L
  create_bd_pin -dir O pwm_CH06_R
  create_bd_pin -dir I -type clk s00_axi_aclk
  create_bd_pin -dir I -from 0 -to 0 -type rst s00_axi_aresetn
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins S00_AXI_CH06] [get_bd_intf_pins PWM_Manager_CH03/S00_AXI]
  ...
  connect_bd_net -net PWMReconstructor_0_pwm_signal [get_bd_pins pwm_CH06_R] [get_bd_pins PWMReconstructor_CH03_R/pwm_signal]
  connect_bd_net -net PWMReconstructor_1_pwm_signal [get_bd_pins pwm_CH06_L] [get_bd_pins PWMReconstructor_CH03_L/pwm_signal]
  connect_bd_net -net PWM_1 [get_bd_pins PWM_CH06] [get_bd_pins PWM_Sampler_CH03/PWM]
...
proc create_hier_cell_Channel_CH04 { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 S00_AXI_CH04_T
  ...
  create_bd_pin -dir O pwm_CH04_T
  create_bd_pin -dir I -type clk s00_axi_aclk
  create_bd_pin -dir I -from 0 -to 0 -type rst s00_axi_aresetn
  ...
  # Create instance: PWMReconstructor_CH04_T, and set properties
  set PWMReconstructor_CH04_T [ create_bd_cell -type ip -vlnv aertec.local:user:PWMReconstructor:1.0 PWMReconstructor_CH04_T ]
  ...
  # Create instance: PWM_Manager_CH04_T, and set properties
  set PWM_Manager_CH04_T [ create_bd_cell -type ip -vlnv aertec.local:user:PWM_Manager:1.0 PWM_Manager_CH04_T ]
  ...
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins S00_AXI_CH04_T] [get_bd_intf_pins PWM_Manager_CH04_T/S00_AXI]

  # Create port connections
  connect_bd_net -net CLK_IN_1 [get_bd_pins CLK] [get_bd_pins PWMReconstructor_CH04_L/clk_in] [get_bd_pins PWMReconstructor_CH04_R/clk_in] [get_bd_pins PWMReconstructor_CH04_T/clk_in] [get_bd_pins PWM_Sampler_CH04/CLK]
  connect_bd_net -net ModeManager_0_mode [get_bd_pins mode] [get_bd_pins PWM_Manager_CH04/mode] [get_bd_pins PWM_Manager_CH04_T/mode]
  ...
  connect_bd_net -net PWMReconstructor_CH04_T_pwm_signal [get_bd_pins pwm_CH04_T] [get_bd_pins PWMReconstructor_CH04_T/pwm_signal]
  ...
  connect_bd_net -net PWM_Manager_CH04_T_pwm_r [get_bd_pins PWMReconstructor_CH04_T/value] [get_bd_pins PWM_Manager_CH04_T/pwm_r]
  connect_bd_net -net PWM_Sampler_0_PWM_Val [get_bd_pins PWM_Manager_CH04/pwm_rc] [get_bd_pins PWM_Manager_CH04_T/pwm_rc] [get_bd_pins PWM_Sampler_CH04/PWM_Val]
  connect_bd_net -net s00_axi_aclk_1 [get_bd_pins s00_axi_aclk] [get_bd_pins PWM_Manager_CH04/s00_axi_aclk] [get_bd_pins PWM_Manager_CH04_T/s00_axi_aclk]
  connect_bd_net -net s00_axi_aresetn_1 [get_bd_pins s00_axi_aresetn] [get_bd_pins PWM_Manager_CH04/s00_axi_aresetn] [get_bd_pins PWM_Manager_CH04_T/s00_axi_aresetn]
...
CONFIG.PCW_WDT_WDT_IO {EMIO}  ] $processing_system7_0
  ...
  connect_bd_intf_net -intf_net Conn8 [get_bd_intf_pins M07_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M07_AXI]
  connect_bd_intf_net -intf_net Conn9 [get_bd_intf_pins M08_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M08_AXI]
  ...
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins peripheral_aresetn] [get_bd_pins axi_gpio_OUTS/s_axi_aresetn] [get_bd_pins axi_uartlite_DBG0/s_axi_aresetn] [get_bd_pins proc_sys_reset_0_1M/ext_reset_in] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M03_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M04_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M05_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M06_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M07_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M08_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]
...
proc create_hier_cell_PWM_MANAGER { parentCell nameHier } {
  ...
  # Create instance: Channel_CH06
  create_hier_cell_Channel_CH06 $hier_obj Channel_CH06
  ...
  connect_bd_intf_net -intf_net Conn6 [get_bd_intf_pins S00_AXI] [get_bd_intf_pins Channel_CH04/S00_AXI_CH04_T]
  connect_bd_intf_net -intf_net Conn7 [get_bd_intf_pins S00_AXI_CH06] [get_bd_intf_pins Channel_CH06/S00_AXI_CH06]

  # Create port connections
  connect_bd_net -net CLK_IN_1 [get_bd_pins CLK_IN] [get_bd_pins Channel_CH01/CLK] [get_bd_pins Channel_CH02/CLK] [get_bd_pins Channel_CH03/CLK] [get_bd_pins Channel_CH04/CLK] [get_bd_pins Channel_CH06/CLK] [get_bd_pins MODE_MANAGER/CLK_IN]
  ...
  connect_bd_net -net Channel_CH04_pwm_signal [get_bd_pins pwm_CH04_T] [get_bd_pins Channel_CH04/pwm_CH04_T]
  connect_bd_net -net Channel_CH06_pwm_CH06_L [get_bd_pins pwm_CH06_L] [get_bd_pins Channel_CH06/pwm_CH06_L]
  connect_bd_net -net Channel_CH06_pwm_CH06_R [get_bd_pins pwm_CH06_R] [get_bd_pins Channel_CH06/pwm_CH06_R]
  connect_bd_net -net ModeManager_0_mode [get_bd_pins Channel_CH01/mode] [get_bd_pins Channel_CH02/mode] [get_bd_pins Channel_CH03/mode] [get_bd_pins Channel_CH04/mode] [get_bd_pins Channel_CH06/mode] [get_bd_pins MODE_MANAGER/mode]
  ...
  connect_bd_net -net PWM_CH06_1 [get_bd_pins PWM_CH06] [get_bd_pins Channel_CH06/PWM_CH06]
  connect_bd_net -net s00_axi_aclk_1 [get_bd_pins s00_axi_aclk] [get_bd_pins Channel_CH01/s00_axi_aclk] [get_bd_pins Channel_CH02/s00_axi_aclk] [get_bd_pins Channel_CH03/s00_axi_aclk] [get_bd_pins Channel_CH04/s00_axi_aclk] [get_bd_pins Channel_CH06/s00_axi_aclk] [get_bd_pins MODE_MANAGER/s00_axi_aclk]
  connect_bd_net -net s00_axi_aresetn_1 [get_bd_pins s00_axi_aresetn] [get_bd_pins Channel_CH01/s00_axi_aresetn] [get_bd_pins Channel_CH02/s00_axi_aresetn] [get_bd_pins Channel_CH03/s00_axi_aresetn] [get_bd_pins Channel_CH04/s00_axi_aresetn] [get_bd_pins Channel_CH06/s00_axi_aresetn] [get_bd_pins MODE_MANAGER/s00_axi_aresetn]
...
proc create_root_design { parentCell } {
  ...
  set pwm_CH04_out_T [ create_bd_port -dir O pwm_CH04_out_T ]
  set pwm_CH06_out_L [ create_bd_port -dir O pwm_CH06_out_L ]
  set pwm_CH06_out_R [ create_bd_port -dir O pwm_CH06_out_R ]
  ...
  set pwm_in_ch05 [ create_bd_port -dir I pwm_in_ch05 ]
  set pwm_in_ch06 [ create_bd_port -dir I pwm_in_ch06 ]
  ...
  connect_bd_intf_net -intf_net Zynq_Systems_M07_AXI [get_bd_intf_pins PWM_MANAGER/S00_AXI] [get_bd_intf_pins Zynq_Systems/M07_AXI]
  connect_bd_intf_net -intf_net Zynq_Systems_M08_AXI [get_bd_intf_pins PWM_MANAGER/S00_AXI_CH06] [get_bd_intf_pins Zynq_Systems/M08_AXI]
  ...
  connect_bd_net -net PWM_CH06_1 [get_bd_ports pwm_in_ch06] [get_bd_pins PWM_MANAGER/PWM_CH06]
  ...
  connect_bd_net -net PWM_MANAGER_pwm_CH06_L [get_bd_ports pwm_CH06_out_L] [get_bd_pins PWM_MANAGER/pwm_CH06_L]
  connect_bd_net -net PWM_MANAGER_pwm_CH06_R [get_bd_ports pwm_CH06_out_R] [get_bd_pins PWM_MANAGER/pwm_CH06_R]
  ...
  connect_bd_net -net PWM_MANAGER_pwm_signal2 [get_bd_ports pwm_CH04_out_T] [get_bd_pins PWM_MANAGER/pwm_CH04_T]
  ...
  connect_bd_net -net pwm_in_mode_1 [get_bd_ports pwm_in_ch05] [get_bd_pins PWM_MANAGER/PWM_MODE]
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x43C60000 [get_bd_addr_spaces Zynq_Systems/processing_system7_0/Data] [get_bd_addr_segs PWM_MANAGER/Channel_CH06/PWM_Manager_CH03/S00_AXI/S00_AXI_reg] SEG_PWM_Manager_CH03_S00_AXI_reg1
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x43C50000 [get_bd_addr_spaces Zynq_Systems/processing_system7_0/Data] [get_bd_addr_segs PWM_MANAGER/Channel_CH04/PWM_Manager_CH04_T/S00_AXI/S00_AXI_reg] SEG_PWM_Manager_CH04_S00_AXI_reg1
